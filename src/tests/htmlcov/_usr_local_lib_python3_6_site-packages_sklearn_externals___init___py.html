...
<head>
    ...
    <title>Coverage for /usr/local/lib/python3.6/site-packages/sklearn/externals/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/usr/local/lib/python3.6/site-packages/sklearn/externals/__init__.py</b> :
...
<p id="t3" class="pln"><span class="str">External, bundled dependencies.</span><span class="strut">&nbsp;</span></p>
